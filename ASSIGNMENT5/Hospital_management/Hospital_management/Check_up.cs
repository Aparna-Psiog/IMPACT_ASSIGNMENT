...
namespace Hospital_management
{
    class Check_up
    {
        public void Cardiology_list(List<Patient_Appointment> Patient_name)
        {
            int userOption;
            string whileOption;
        ...
        public void Neurology_list(List<Patient_Appointment> Patient_name)
        {
            int userOption;
            string whileOption;
            Patient_Appointment patientdetails = new Patient_Appointment();
        ...
        public void Dermatology_list(List<Patient_Appointment> Patient_name)
        {
            int userOption = 0;
            string whileOption;
            Patient_Appointment patientdetails = new Patient_Appointment();
        ...
        public void Generalcheckup_list(List<Patient_Appointment> Patient_name)
        {
            int userOption;
            string whileOption;
            Patient_Appointment patientdetails = new Patient_Appointment();
