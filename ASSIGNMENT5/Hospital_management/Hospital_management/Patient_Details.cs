       ...
       public void details()
        {
            ...
            while (true)
            {
                ...
                if (patientresident)
                {
                    ...
                    Console.WriteLine("Hospital: " + residentpatient.HospitalName + " / ");
                    Console.WriteLine(String.Format("{0:(###) ###-####}", Convert.ToInt64(contact.HospitalPhone)));
                }
                else
                {
                    //Format and output contact names and phone number
                    Console.WriteLine("Contact: " + FormatName(outpatient.ContactFirstName) + " , " + FormatName(outpatient.ContactLastName) + " / ");
                    Console.WriteLine(String.Format("{0:(###) ###-####}", Convert.ToInt64(contact.ContactPhone)));
                }
